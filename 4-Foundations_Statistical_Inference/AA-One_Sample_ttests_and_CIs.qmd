...
In this activity, you will execute statistical hypothesis tests and generate confidence intervals for each of the Big 5 personality traits using data collected from a random sample of Stat 225 sstudents.  
...
Contextual:  I have sufficient evidence to suggest that Stat 225 students are, on average, more Extroverted than the general population.  

5. Create a Confidence Interval for the average extroversion of Stat 225 students:  
...
I am 97.5% confident that the true average extroversion of Stat 225 students is somewhere between the 54.62 and 59.34 percentiles.  

# Agreeableness

State your null and alternative hypotheses.  For example, do you think Stat 225 students are more, less, or just different than the general population?  
...
5. Create a Confidence Interval for the average agreeableness of Stat 225 students:  
...
5. Create a Confidence Interval for the average openness of Stat 225 students:  
...
5. Create a Confidence Interval for the average neuroticism of Stat 225 students:  
...
5. Create a Confidence Interval for the average conscientiousness of Stat 225 students:  
